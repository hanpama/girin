...
class Orders:
    class Order:
        class Order(typing.Protocol):
            ...
            async def bookmarks(self, obj: source_spec.OrderSource, info: graphql.GraphQLResolveInfo, first: int | None, after: source_spec.CursorSource | None, last: int | None, before: source_spec.CursorSource | None, filters: list[source_spec.BookmarkFilterSource] | None) -> source_spec.BookmarkConnectionSource: ...
